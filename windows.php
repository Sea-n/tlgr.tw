...
<html lang="zh-TW">
	<head>
		<title>Windows Telegram 客戶端版本比較</title>
		...
		<meta itemprop="name" content="Windows Telegram 客戶端版本比較">
		...
		<meta name="twitter:title" content="Windows Telegram 客戶端版本比較">
		...
		<meta name="og:title" content="Windows Telegram 客戶端版本比較">
		...
		<meta name="og:url" content="https://tlgr.tw/windows">
	...
	<body>
		<div class="content">
			...
			<table>
				...
				<tbody>
					...
					<tr>
						<td>Unigram</td>
						<td class="table-yes2">可手動套用翻譯檔</td>
						<td class="table-partial">2018 July</td>
						<td class="table-yes hide500">獨立開發</td>
					</tr>
				</tbody>
			</table>
			...
			<h2><a class="anchor" name="unigram" href="#unigram" id="unigram"><i class="anchor-icon"></i></a>Unigram</h2>
			<p class="comments-section">官方網站: <a href="https://github.com/UnigramDev/Unigram" target="_blank">GitHub</a></p>
			<p>推薦指數：★★☆☆☆</p>
			...
			<div class="comp">
				<div class="pros">
					<h3>優點</h3>
					<ol>
						<li>遵守 Windows Material Design</li>
					</ol>
				</div>
				<div class="cons">
					<h3>缺點</h3>
