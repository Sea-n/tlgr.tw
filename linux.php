...
<html lang="zh-TW">
	<head>
		<title>Linux Telegram 客戶端版本比較</title>
		...
		<meta itemprop="name" content="Linux Telegram 客戶端版本比較">
		...
		<meta name="twitter:title" content="Linux Telegram 客戶端版本比較">
		...
		<div class="content">
			...
			<table>
				...
				<tbody>
					...
					<tr>
						<td>telegram-cli</td>
						<td class="table-no">無</td>
						<td class="table-partial">Mar 23</td>
						<td class="table-yes hide500">獨立開發</td>
					</tr>
				</tbody>
			</table>
			...
			<h2><a class="anchor" name="cli" href="#cli" id="cli"><i class="anchor-icon"></i></a>telegram-cli</h2>
			<p class="comments-section">官方網站: <a href="https://github.com/vysheng/tg" target="_blank">GitHub</a></p>
			<p>推薦指數：★★★☆☆</p>
